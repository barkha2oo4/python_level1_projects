    ...
    while len(word)>0:
        ...
        if guess not in word:
            ...
            if turns == 2:
                ...
                print("      / \      ")
            if turns == 1:
                print("1 turns left!!! hangon on his last breath")
                print("---------------")
                print("      \O/_|    ")
                print("       |       ")
                print("      / \      ")
