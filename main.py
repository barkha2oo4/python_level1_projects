...
def input_char_in_world(selected_word, input_char, current_word_state, attempts_remaining):
    flag=0
...
#   it will store value of randomly picked word
    selected_word = pick_random_word()
    
    # it will show current status of the word
    current_word_state =""
    for i in selected_word:
      if i ==" " or i =="o" or i=="a" or i=='i'or i =='u'or i=='e':
        current_word_state+=1
    else:
    ...
    while True:
        ...
        print("")
        current_word_state,attempts_remaining= input_char_in_world(selected_word,input_char,current_word_state,attempts_remaining)
        print_current_state(current_word_state,attempts_remaining)
